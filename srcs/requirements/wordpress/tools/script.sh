...
# php /var/www/wp-admin/install.php --url=http://zcherrad.42.fr/ --title="INCEPTION" --admin_user=zcherrad --admin_password=password --admin_email=zinebcherradi78@gmail.com
